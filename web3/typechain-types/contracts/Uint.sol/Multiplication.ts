...
export interface MultiplicationInterface extends Interface {
  getFunction(nameOrSignature: "answer"): FunctionFragment;
...
export interface Multiplication extends BaseContract {
  connect(runner?: ContractRunner | null): Multiplication;
