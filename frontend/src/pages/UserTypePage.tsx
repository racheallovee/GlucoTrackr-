...
import { LogIn, UserPlus, ArrowLeft, Eye, EyeOff, Mail, Lock, User } from "lucide-react";
...
const UserTypePage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `Welcome to GlucoTrackr ${isSignUp ? "! Your account has been created" : ""}!`,
      });
  ...
  const userTypeContent = {
    patients: {
      ...
      description: "GlucoTrackr empowers you with real-time glucose monitoring, personalized insights, and smart alerts to manage your diabetes effectively. Stay connected to your health journey like never before.",
    ...
    doctors: {
      ...
      description: "Elevate your practice with GlucoTrackr's comprehensive patient management system. Monitor patient data in real-time, provide timely interventions, and improve treatment outcomes with our cutting-edge platform.",
      color: "from-green-400 to-teal-300",
      bgPattern: "url(\"data:image/svg+xml,%3Csvg width='84' height='48' viewBox='0 0 84 48' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h12v6H0V0zm28 8h12v6H28V8zm14-8h12v6H42V0zm14 0h12v6H56V0zm0 8h12v6H56V8zM42 8h12v6H42V8zm0 16h12v6H42v-6zm14-8h12v6H56v-6zm14 0h12v6H70v-6zm0-16h12v6H70V0zM28 32h12v6H28v-6zM14 16h12v6H14v-6zM0 24h12v6H0v-6zm0 8h12v6H0v-6zm14 0h12v6H14v-6zm14 8h12v6H28v-6zm-14 0h12v6H14v-6zm28 0h12v6H42v-6zm14-8h12v6H56v-6zm0-8h12v6H56v-6zm14 8h12v6H70v-6zm0 8h12v6H70v-6zM14 24h12v6H14v-6zm14-8h12v6H28v-6zM14 8h12v6H14V8zM0 8h12v6H0V8z' fill='%23ffffff' fill-opacity='0.15' fill-rule='evenodd'/%3E%3C/svg%3E\")",
      image: "https://source.unsplash.com/NFvdKIhxYlU/600x800",
    },
    researchers: {
      title: "Accelerate Your Research",
      description: "Unlock new possibilities in diabetes research with GlucoTrackr's extensive data analytics platform. Access anonymized patient data, identify patterns, and contribute to groundbreaking discoveries in diabetes management.",
      color: "from-blue-500 to-indigo-400",
      bgPattern: "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23ffffff' fill-opacity='0.15' fill-rule='evenodd'%3E%3Ccircle cx='3' cy='3' r='3'/%3E%3Ccircle cx='13' cy='13' r='3'/%3E%3C/g%3E%3C/svg%3E\")",
              ...
              <div className="w-24 h-24 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                {userType === "patients" ? (
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L14.5 9H22L16 13.5L18 21L12 17L6 21L8 13.5L2 9H9.5L12 2Z" fill="white"/>
                  </svg>
                ) : userType === "doctors" ? (
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 10H21M3 14H21M8 3V21M16 3V21" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                ) : (
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22ZM12 6V18M6 12H18" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                )}
              </div>
            </motion.div>
