...
import { 
  BarChart, Database, Search, FileText, 
  Menu, X, Users, Activity, LineChart 
} from "lucide-react";
        ...
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="text-xl font-bold text-glucotrack-dark-gray">
              Gluco<span className="text-glucotrack-blue">Trackr</span> <span className="text-sm font-normal bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">Researcher</span>
            </span>
          </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1">
              {activeTab === "overview" && "Welcome to your research portal. Access anonymized health data."}
              {activeTab === "analytics" && "Analyze trends and patterns in diabetes health data."}
              {activeTab === "datasets" && "Browse and access available anonymized datasets."}
              {activeTab === "reports" && "Generate and view research reports."}
              {activeTab === "participants" && "View anonymized participant information."}
            </p>
          </div>
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-100 mb-6">
                <div className="flex items-center justify-center h-64">
                  <div className="flex flex-col items-center">
                    <LineChart size={48} className="text-glucotrack-blue/30 mb-4" />
                    <p className="text-gray-500 mb-4">Connect your wallet to view analytics</p>
                    <ConnectWallet />
                  </div>
                </div>
              </div>
          ...
          {activeTab === "datasets" && (
            <Card className="p-6 shadow-md">
              ...
              <div className="flex flex-col items-center justify-center py-10">
                ...
                <p className="text-gray-500 mb-4">Connect your wallet to access datasets</p>
                <ConnectWallet />
              </div>
            </Card>
          )}
          ...
          {(activeTab === "reports" || activeTab === "participants") && (
            <Card className="p-6 shadow-md">
              <div className="flex flex-col items-center justify-center py-10">
                {activeTab === "reports" && <FileText size={48} className="text-glucotrack-blue mb-4" />}
                {activeTab === "participants" && <Users size={48} className="text-glucotrack-blue mb-4" />}
                ...
                <p className="text-gray-500 text-center max-w-md mb-6">
                  {activeTab === "reports" && "Connect your wallet to generate and view research reports."}
                  {activeTab === "participants" && "Connect your wallet to view anonymized participant information."}
                </p>
