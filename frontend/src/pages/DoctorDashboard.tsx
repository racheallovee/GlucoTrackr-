...
import { 
  Activity, Users, UserCheck, Search, Stethoscope, 
  FileText, Menu, X, MessageSquare, Calendar 
} from "lucide-react";
        ...
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="text-xl font-bold text-glucotrack-dark-gray">
              Gluco<span className="text-glucotrack-blue">Trackr</span> <span className="text-sm font-normal bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">Doctor</span>
            </span>
          </div>
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1">
              {activeTab === "overview" && "Welcome back, Doctor! Your patient overview."}
              {activeTab === "patients" && "Manage your patient list and access patient data."}
              {activeTab === "records" && "View and analyze patient health records."}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="p-6 shadow-md">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-3xl font-bold text-glucotrack-dark-gray">{mockPatients.length}</p>
              ...
              <Card className="p-6 shadow-md">
                <h3 className="text-lg font-semibold mb-2 flex items-center">
                  <MessageSquare size={18} className="mr-2 text-glucotrack-blue" />
                  Recent Messages
                </h3>
                <p className="text-gray-500 text-sm">
            ...
            <Card className="p-6 shadow-md">
              ...
              {filteredPatients.length > 0 ? (
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {filteredPatients.map((patient) => (
                        <tr key={patient.id}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <button className="text-glucotrack-blue hover:underline">View Records</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                ...
                <div className="flex flex-col items-center justify-center py-10">
                  ...
                  <p className="text-gray-500">No patients found with that name.</p>
                </div>
              )}
          ...
          {(activeTab === "records" || activeTab === "appointments" || activeTab === "messages") && (
            <Card className="p-6 shadow-md">
              <div className="flex flex-col items-center justify-center py-10">
                {activeTab === "records" && <FileText size={48} className="text-glucotrack-blue mb-4" />}
                {activeTab === "appointments" && <Calendar size={48} className="text-glucotrack-blue mb-4" />}
                {activeTab === "messages" && <MessageSquare size={48} className="text-glucotrack-blue mb-4" />}
                ...
                <p className="text-gray-500 text-center max-w-md mb-6">
                  {activeTab === "records" && "Connect your wallet to access patient health records."}
                  {activeTab === "appointments" && "Connect your wallet to view and manage your appointments."}
                  {activeTab === "messages" && "Connect your wallet to access your patient communications."}
                </p>
