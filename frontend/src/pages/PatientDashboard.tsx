        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 mt-1">
              {activeTab === "overview" &&
                "Welcome back! Here's your health at a glance."}
              {activeTab === "records" &&
                "View and manage your blockchain-secured health records."}
              {activeTab === "data" &&
                "Log your daily health measurements securely."}
          ...
          {activeTab === "overview" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="p-6 shadow-md">
                ...
                <p className="text-gray-500 text-sm">
                  Your health data is secured and private. Log data to see a
                  summary.
                </p>
                <button
            ...
            <Card className="p-6 shadow-md">
              <div className="flex flex-col items-center justify-center py-10">
                ...
                <p className="text-gray-500 text-center max-w-md mb-6">
                  Control which healthcare providers can access your health
                  records.
                </p>
                <ConnectWallet />
              </div>
